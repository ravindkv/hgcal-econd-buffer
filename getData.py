...
parser.add_argument('--filesPerJob',default=1,type=int)
...
if args.source=="old":
    ...
    outputName = "Data/updated_ttbar_DAQ_data_{args.i}.csv"
    ...
    outputName = "Data/ttbar_startupNoise_DAQ_data_{args.i}.csv"
    ...
    outputName = "Data/ttbar_eolNoise_DAQ_data_{args.i}.csv"
else:
